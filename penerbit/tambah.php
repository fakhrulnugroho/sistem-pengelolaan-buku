...
<head>
	...
	<title><?php echo title('Tambah Data Penerbit') ?></title>
...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<!-- Page Content -->
		<div class="clearfix">
			<h1 class="float-left">Tambah Data Penerbit</h1>
		...
		<?php endif; ?>
		<form action="<?php echo base_url('penerbit/proses_tambah.php') ?>" method="POST" class="col-md-6">
			<div class="form-group">
				<label for="nama_penerbit">Nama Penerbit</label>
				<input type="text" name="nama_penerbit" id="nama_penerbit" placeholder="Masukan Nama Penerbit" autocomplete="off" required="required" class="form-control">
			</div>
			<div class="form-group">
